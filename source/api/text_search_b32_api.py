...
from models.clip_b32 import CLIP32
from models.vi2en import Translator



# Đường dẫn lưu file feature của clip model
CLIP_FEATURES_PATH= ['/dataset/AIC2023/minerva_dataset/0/features/clip_b32/',
                     '/dataset/AIC2023/minerva_dataset/1/features/clip_b32/']
KEYFRAME_FOLDER_PATH = "/dataset/AIC2023/minerva_dataset/"
...
def indexing_methods_faiss(clip_features_path):
    faiss_db = faiss.IndexFlatIP(512)
    db = []
...
if __name__ == '__main__':
    app.run(host="0.0.0.0", port= 8406, debug=False)